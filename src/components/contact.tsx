...
export default function Contact() {
  ...
  >
    ...
    <div
      className="text-main flex justify-center items-center flex-col md:flex-row md:justify-around"
    >
   
      <div
        className="border rounded-sm w-full max-w-xs text-center bg-zinc-50 py-16 px-4 mb-5 md:mb-0 lg:px-8"
      >
        <Image
          width="66"
          height="48"
      ...
      <div
        className="border rounded-sm w-full max-w-xs text-center bg-zinc-50 py-16 px-4 mn-5 md:mb-0 lg:px-8"
      >
        <Image
          width="48"
          height="48"
        ...
        />
        <p className="font-bold mb-1 md:text-lg lg:text-xl text-black">
          Numéro de téléphone
        </p>
