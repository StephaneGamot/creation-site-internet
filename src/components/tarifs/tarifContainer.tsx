...
<div className="container mx-auto px-4">
				<h3 className="text-center text-black text-3xl mb-4">Création de site internet avec WordPress</h3>
				...
				<div>
                <h3 className="text-center text-black text-3xl mb-4">Création de site internet avec React - Next</h3>
