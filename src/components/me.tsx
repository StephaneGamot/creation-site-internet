...
export default function Me() {
	return (
		<section className="max-w-[1200px] p-5 m-auto">
			<p>
				Originaire du Pays Basque (une région située dans la montagne des Pyrénées, au bord de l’océan Atlantique, en partie sur la France et sur l’Espagne), j’ai grandi au sein d’une grande
			...
			<p>
				Face à l&apos;incapacité de la médecine occidentale à me soigner, j&apos;ai décidé de me tourner vers les médecines holistiques et orientales. La Médecine Traditionnelle Chinoise et
				tous ses dérivés ont suscité un intérêt particulier en moi. J&apos;ai enfin pu constater l&apos;évolution de mon corps.{" "}
			</p>
			<p>
